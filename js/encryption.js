...
function doEncrypt(){
    ...
    if(encrypted != ''){
        ...
        $('#encrypt-encrypted_message').val(encrypted);
        $('#div-encrypt-encrypted_message').html($('#encrypt-encrypted_message').val());
...
function doDecrypt(message, passphrase){
	...
	var encrypted = message.val();
	var decrypted = CryptoJS.AES.decrypt(encrypted, passphrase.val(), { format: JsonFormatter });
